...
namespace magnetic_dynamic_compensation {
        ...
        private:
            ...
            void handle(const geometry_msgs::Vector3Stamped::ConstPtr& msg) {
                ...
                BOOST_FOREACH(const FieldInfo &info, fieldinfo_map | boost::adaptors::map_values) {
                    ...
                    tf::Vector3 this_mag_field; tf::vector3MsgToTF(info.magnetic_field, this_mag_field);
    ...
    PLUGINLIB_DECLARE_CLASS(magnetic_dynamic_compensation, nodelet, magnetic_dynamic_compensation::Nodelet, nodelet::Nodelet);
}
